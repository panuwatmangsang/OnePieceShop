...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="/images/poster/poster4.jpg" id="ProductImg" width="60%" height="80%">
            </div>
            <div class="col-2">
                <p>Home / Poster Images</p>
                <h1>Charlotte Linlin</h1>
                <h4>450 THB</h4>
                ...
                <p>สืนค้าใหม่ 100% <br>
                    ...
                    บรรจุภัณฑ์: Poster Charlotte Linlin + กล่อง
                </p>
            </div>
        </div>
    </div>
