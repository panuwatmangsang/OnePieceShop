...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="/images/sundry/bepo2/bepo21.jpg" id="ProductImg" width="100%" height="500">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="/images/sundry/bepo2/bepo21.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/sundry/bepo2/bepo22.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/sundry/bepo2/bepo23.jpg" class="small-img" width="100%" height="500">
                    </div>
                </div>
            </div>
            <div class="col-2">
