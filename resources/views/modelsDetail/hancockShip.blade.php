...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="/images/model/hancock-ship/hancock-ship.jpg" id="ProductImg" width="100%" height="500">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="/images/model/hancock-ship/hancock-ship.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/hancock-ship/hancock-ship2.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/hancock-ship/hancock-ship3.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/hancock-ship/hancock-ship4.jpg" class="small-img" width="100%" height="500">
                    </div>
                </div>
            </div>
            <div class="col-2">
                ...
                <p>สืนค้าใหม่ 100% <br>
                    ...
                    ขนาดประมาณ: สูง 8 X กว้าง 8 cm <br>
                    น้ำหนัก: ประมาณ 1 กก <br>
                    บรรจุภัณฑ์: Hancock Ship + กล่อง
                </p>
            </div>
        </div>
    </div>
