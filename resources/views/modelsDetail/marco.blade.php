...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="/images/model/mulgo/mulgo.jpg" id="ProductImg" width="100%" height="500">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="/images/model/mulgo/mulgo.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/mulgo/mulgo2.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/mulgo/mulgo3.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/mulgo/mulgo.jpg" class="small-img" width="100%" height="500">
                    </div>
            ...
            <div class="col-2">
                ...
                <p>สืนค้าใหม่ 100% <br>
                    ...
                    ขนาดประมาณ: สูง 20 X กว้าง 8 cm <br>
                    น้ำหนัก: ประมาณ 0.8 กก <br>
                    บรรจุภัณฑ์: Marco + กล่อง
                </p>
            </div>
        </div>
    </div>
