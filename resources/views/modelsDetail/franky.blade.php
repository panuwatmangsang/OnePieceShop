...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="/images/model/frankky/frankky.jpg" id="ProductImg" width="100%" height="500">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="/images/model/frankky/frankky.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/frankky/frankky2.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/frankky/frankky3.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/frankky/frankky4.jpg" class="small-img" width="100%" height="500">
                    </div>
                </div>
            </div>
            <div class="col-2">
                ...
                <p>สืนค้าใหม่ 100% <br>
                    ...
                    น้ำหนัก: ประมาณ 10 กก <br>
                    บรรจุภัณฑ์: Franky + กล่อง
                </p>
            </div>
        </div>
    </div>
