...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="/images/model/jinbe/jinbe.jpg" id="ProductImg" width="100%" height="500">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="/images/model/jinbe/jinbe.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/jinbe/jinbe2.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/jinbe/jinbe3.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/jinbe/jinbe4.jpg" class="small-img" width="100%" height="500">
                    </div>
                </div>
            </div>
            <div class="col-2">
