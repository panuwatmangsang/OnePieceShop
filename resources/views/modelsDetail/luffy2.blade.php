...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="/images/model/luffy2/luffy21.jpg" id="ProductImg" width="100%">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="/images/model/luffy2/luffy21.jpg" class="small-img" width="100%">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/luffy2/luffy22.jpg" class="small-img" width="100%">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/luffy2/luffy21.jpg" class="small-img" width="100%">
                    </div>
            ...
            <div class="col-2">
                ...
                <p>สืนค้าใหม่ 100% <br>
                    ...
                    ขนาดประมาณ: สูง 10 X กว้าง 8 cm <br>
