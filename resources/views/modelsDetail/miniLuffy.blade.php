...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="/images/model/mini-luffy/mini-luffy.jpg" id="ProductImg" width="100%" height="500">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="/images/model/mini-luffy/mini-luffy.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/mini-luffy/mini-luffy2.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/mini-luffy/mini-luffy3.jpg" class="small-img" width="100%" height="500">
                    </div>
                    <div class="small-img-col">
                        <img src="/images/model/mini-luffy/mini-luffy4.jpg" class="small-img" width="100%" height="500"> 
                    </div>
                </div>
            </div>
            <div class="col-2">
                ...
                <p>สืนค้าใหม่ 100% <br>
                    ...
                    ขนาดประมาณ: สูง 5 X กว้าง 4 cm <br>
                    น้ำหนัก: ประมาณ 0.5 กก <br>
